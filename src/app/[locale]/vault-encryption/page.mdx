...
# Encrypt locally before pushing as a public dead drop
sirr push "$(echo 'pg://user:pass@host/db' | age -r age1...)" --ttl 1h

# Or set as an org secret
sirr set db/prod="$(echo 'pg://user:pass@host/db' | age -r age1...)" --org $SIRR_ORG --ttl 1h

# Decrypt after retrieving
sirr get db/prod --org $SIRR_ORG | age -d -i key.txt
```
