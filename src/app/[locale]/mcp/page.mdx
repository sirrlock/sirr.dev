  ...
  <Col>
    ...
    <Properties>
      ...
      <Property name="SIRR_ORG" type="string">
        Organization ID for multi-tenant mode. When set, all secret, audit, and webhook operations are scoped to this org. Required for Cloud users; optional for self-hosted.
      </Property>
    </Properties>
