...
Push a public dead drop with a 1-hour TTL and a single-read limit. Once read, it is gone.
...
# → {"id": "a3f8...7c2d", "url": "https://sirrlock.com/s/a3f8...7c2d"}
```
...
```bash {{ title: 'cURL' }}
curl http://localhost:39999/secrets/a3f8...7c2d \
  -H "Authorization: Bearer $SIRR_MASTER_KEY"
```
