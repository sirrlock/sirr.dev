...
curl -X POST http://localhost:39999/secrets \
  -H "Authorization: Bearer $SIRR_MASTER_API_KEY" \
...
# → {"id": "a3f8...7c2d", "url": "https://sirr.sirrlock.com/s/a3f8...7c2d"}
```
  ...
  "mcpServers": {
    "sirr": {
      ...
      "env": {
        ...
        "SIRR_TOKEN": "<your-SIRR_MASTER_API_KEY>"
      }
    }
  }
}
...
SIRR_SERVER=http://localhost:39999 \
SIRR_TOKEN=$SIRR_MASTER_API_KEY \
sirr-mcp --health
# → OK
```
