  ...
  return [
    {
      ...
      links: [
        ...
        { title: t('nav.links.quickstartSoloDev'), href: `${prefix}/quickstart/solo-dev` },
        { title: t('nav.links.quickstartDevops'), href: `${prefix}/quickstart/devops` },
        { title: t('nav.links.quickstartMultiTeam'), href: `${prefix}/quickstart/multi-team` },
        { title: t('nav.links.install'), href: `${prefix}/install` },
    ...
    },
    {
      ...
      links: [
        ...
        { title: t('nav.links.auditLogs'), href: `${prefix}/audit-logs` },
        { title: t('nav.links.webhooks'), href: `${prefix}/webhooks` },
        { title: t('nav.links.apiKeys'), href: `${prefix}/api-keys` },
    ...
    },
    {
      ...
      links: [
        ...
        { title: t('nav.links.n8n'), href: `${prefix}/n8n` },
        { title: t('nav.links.openclaw'), href: `${prefix}/openclaw` },
        { title: t('nav.links.aiWorkflows'), href: `${prefix}/ai-workflows` },
        { title: t('nav.links.blog'), href: `${prefix}/blog` },
      ],
    },
  ]
}
...
export const navigation: Array<NavGroup> = [
  {
    ...
    links: [
      ...
      { title: 'Solo Dev', href: '/quickstart/solo-dev' },
      { title: 'DevOps', href: '/quickstart/devops' },
      { title: 'Multi-Team', href: '/quickstart/multi-team' },
  ...
  },
  {
    ...
    links: [
      ...
      { title: 'n8n Integration', href: '/n8n' },
      { title: 'OpenClaw Integration', href: '/openclaw' },
  ...
  return (
    <nav {...props}>
      <ul role="list">
        ...
        <TopLevelNavItem href="https://github.com/sirrlock/sirr">
