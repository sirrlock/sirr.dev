...
function ResourcePattern({
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-linear-to-r from-[#e0ecf7] to-[#d4e4f5] opacity-0 transition duration-300 group-hover:opacity-100 dark:from-[#1a2a3e] dark:to-[#1e3350]"
        style={style}
      />
      <motion.div
