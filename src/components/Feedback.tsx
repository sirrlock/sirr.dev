...
>(function FeedbackThanks({ className, ...props }, ref) {
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-full bg-brand-50/50 py-1 pr-3 pl-1.5 text-sm text-brand-900 ring-1 ring-brand-500/20 ring-inset dark:bg-brand-500/5 dark:text-brand-200 dark:ring-brand-500/30">
